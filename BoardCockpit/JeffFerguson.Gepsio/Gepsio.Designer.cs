...
namespace JeffFerguson.Gepsio {
    ...
    internal class Gepsio {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The XBRL schema at {0} could not be read due to error that occurred while accessing the network through a pluggable protocol. More information is available from the thrown exception&apos;s inner exception..
        /// </summary>
